...
add_action('init', 'cagov_design_system_register_post_list');
 ...
 */
function cagov_design_system_register_post_list()
{
    ...
    register_block_type('ca-design-system/post-list', array(
        ...
        'render_callback' => 'cagov_design_system_post_list_dynamic_render_callback'
    ));
}

function cagov_design_system_post_list_dynamic_render_callback($block_attributes, $content)
{
    $host = "http://";
...
function cagov_design_system_gb_register_post_list_web_component_callback()
{
